const data = [
  {
    id: "615a17fafc13ae2b0100044c",
    course_name: "Lane",
    category: "() { 0; }; touch /tmp/blns.shellshock1.fail;",
    rating: 31,
    rating_count: 72,
    instructor: '"',
    price: 61,
    ...
    course_overview: "58.199.95.109",
  },
  {
    id: { $oid: "615a17fafc13ae2b0100044d" },
    course_name: "Susanna",
    category: "␣",
    rating: 48,
    rating_count: 39,
    ...
    course_overview: "132.67.80.0",
  },
  {
    id: { $oid: "615a17fafc13ae2b0100044e" },
    course_name: "Sandor",
    category: "1",
    rating: 35,
    rating_count: 64,
    ...
    course_overview: "38.187.110.212",
  },
  {
    id: { $oid: "615a17fafc13ae2b0100044f" },
    course_name: "Wyatt",
    category: "␢",
    rating: 3,
    rating_count: 88,
    ...
    course_overview: "37.165.52.62",
  },
  {
    id: { $oid: "615a17fafc13ae2b01000450" },
    course_name: "Desi",
    category: "(╯°□°）╯︵ ┻━┻)  ",
    rating: 37,
    rating_count: 22,
    ...
    course_overview: "235.48.133.165",
  },
  {
    id: { $oid: "615a17fafc13ae2b01000451" },
    course_name: "Haven",
    category: "1E02",
    rating: 97,
    rating_count: 93,
    instructor: "../../../../../../../../../../../etc/hosts",
    price: 1,
    duration: 87,
    enrolled: 53,
    language: "œ∑´®†¥¨ˆøπ“‘",
    ...
    course_overview: "246.58.53.24",
  },
  {
    id: { $oid: "615a17fafc13ae2b01000452" },
    course_name: "Roseann",
    category: "test⁠test‫",
    rating: 38,
    rating_count: 11,
    ...
    course_overview: "207.140.190.241",
  },
  {
    id: { $oid: "615a17fafc13ae2b01000453" },
    course_name: "Leonard",
    category: "0/0",
    rating: 41,
    rating_count: 32,
    ...
    course_overview: "229.97.4.58",
  },
  {
    id: { $oid: "615a17fafc13ae2b01000454" },
    course_name: "Goober",
    category: "''",
    rating: 25,
    rating_count: 2,
    ...
    course_overview: "41.253.67.127",
  },
  {
    id: { $oid: "615a17fafc13ae2b01000455" },
    course_name: "Agustin",
    category: "̦H̬̤̗̤͝e͜ ̜̥̝̻͍̟́w̕h̖̯͓o̝͙̖͎̱̮ ҉̺̙̞̟͈W̷̼̭a̺̪͍į͈͕̭͙̯̜t̶̼̮s̘͙͖̕ ̠̫̠B̻͍͙͉̳ͅe̵h̵̬͇̫͙i̹͓̳̳̮͎̫̕n͟d̴̪̜̖ ̰͉̩͇͙̲͞ͅT͖̼͓̪͢h͏͓̮̻e̬̝̟ͅ ̤̹̝W͙̞̝͔͇͝ͅa͏͓͔̹̼̣l̴͔̰̤̟͔ḽ̫.͕",
    rating: 29,
    rating_count: 88,
    instructor: ",./;'[]\\-=",
    price: 34,
    ...
    course_overview: "209.196.31.168",
  },
];
